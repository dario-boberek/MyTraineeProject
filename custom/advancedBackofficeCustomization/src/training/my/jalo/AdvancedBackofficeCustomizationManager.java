...
import training.my.constants.AdvancedBackofficeCustomizationConstants;
 ...
 */
public class AdvancedBackofficeCustomizationManager extends GeneratedAdvancedBackofficeCustomizationManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(AdvancedBackofficeCustomizationManager.class.getName());
	 ...
	 */
	public static AdvancedBackofficeCustomizationManager getInstance()
	{
		return (AdvancedBackofficeCustomizationManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(AdvancedBackofficeCustomizationConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public AdvancedBackofficeCustomizationManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of AdvancedBackofficeCustomizationManager called.");
		}
	}
